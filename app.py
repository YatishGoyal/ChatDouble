...
if not API_KEY:
    ...
    genai_client = genai.Client(api_key="AIzaSyBUHZLlqoHJso6pqLbyQ5MeA403EoDOJYk")
...
"""
    ...
    model_name = "gemini-1.5-flash-latest"  # general model; change if you prefer flash versions
    try:
